  ...
  return (
    <header className="absolute top-0 w-full z-40 glass border-b border-border/50 h-16 flex items-center justify-between px-4 md:px-6">
      ...
      <div className="flex items-center gap-3 md:gap-4">
        <button className="flex items-center justify-center w-10 h-10 rounded-full bg-card border border-border/50 hover:bg-primary/10 text-text-secondary hover:text-primary transition-colors">
          <Bell size={18} />
        </button>
        <Link href="/profile" className="flex items-center justify-center w-10 h-10 rounded-full bg-card border border-border/50 hover:bg-primary/10 text-text-secondary hover:text-primary transition-colors">
          <UserCircle2 size={20} />
        </Link>
      </div>
    </header>
